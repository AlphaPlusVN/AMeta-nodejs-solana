...
export const web3Kar = new Web3(Web3.givenProvider || KAR_RPC_ENDPOINT);
export const APlusContract = new web3Kar.eth.Contract(getAplusABI(), KAR_APLUS_CONTRACT_ADDRESS);
export const NFTContract = new web3Kar.eth.Contract(getNFTABI(), KAR_NFT_ADDRESS);
